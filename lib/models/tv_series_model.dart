...
//   factory TvSireisModel.fromRawJson(String str) =>
//       TvSireisModel.fromJson(json.decode(str));

//   String toRawJson() => json.encode(toJson());

//   factory TvSireisModel.fromJson(Map<String, dynamic> json) => TvSireisModel(
//         page: json["page"],
//         results:
...
// enum OriginCountry { CA, GB, JP, US }
